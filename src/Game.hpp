...
namespace coup
{
    ...
    private:
        ...
        shared_ptr<Player> last_player_couped;                  // variable to store the player who was couped
        int bank_balance_;
    public:
        ...
        // check if the number of players is valid (between 2 and 6)
        ...
        // new function to get the last player couped
